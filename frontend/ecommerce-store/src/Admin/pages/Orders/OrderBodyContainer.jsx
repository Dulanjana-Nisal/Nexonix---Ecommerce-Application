function OrderBodyContainer({ orders, toggleView, setToggleView, deleteCancelledOrder, toggleEdit, setUpdateDetails, setToggleEdit, updateOrders }) {
    return (
        <div className="orders-container-body">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th className="qunatity">Qunatity</th>
                                    ...
                                    <>
                                        ...
                                        <tr className='list-card'>
                                            ...
                                            <td className="status row">
                                                <p className={(items.status).toLowerCase()}>{items.status}</p>
                                            </td>
...
export default OrderBodyContainer;