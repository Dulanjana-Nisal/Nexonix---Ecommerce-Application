        ...
        <>
            <div class="category-container">
                ...
                <div class="container-footer">
                    <div class="category-card" onClick={() => navigate('/products/computers')}>
                    ...
                    <div class="category-card" onClick={() => navigate('/products/laptops')}>
                        <div class="card-header">
                    ...
                    <div class="category-card" onClick={() => navigate('/products/components')}>
                        <div class="card-header">
                    ...
                    <div class="category-card" onClick={() => navigate('/products/gamings')}>
                        <div class="card-header">
                    ...
                    <div class="category-card" onClick={() => navigate('/products/softwares')}>
                        <div class="card-header">
