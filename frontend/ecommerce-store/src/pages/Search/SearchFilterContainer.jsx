function SearchFilterContainer({ clearFilters, filterTags, brandName, productBrands, brandsFilter, ratingsFilter, ratingRange, priceValues, setPriceValues, submitPriceValue, filterByAvailability, availability }) {
    return (
